...
export default function Pagination({ pageIndex, isFirstPage, isLastPage }: { pageIndex: number, isFirstPage: boolean, isLastPage: boolean }) {
  ...
  return (
    <div className="mt-10 flex items-center justify-center dark:bg-white dark:text-black">
      <nav
